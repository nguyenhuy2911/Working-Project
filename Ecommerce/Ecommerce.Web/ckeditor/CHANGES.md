...
* [#11926](http://dev.ckeditor.com/ticket/11926): Fixed: [Code Snippet](http://ckeditor.com/addon/codesnippet) does not decode HTML EcommerceModel_DbContext when loading code from the `<code>` element.
...
* [#11536](http://dev.ckeditor.com/ticket/11536): Added the [`CKEDITOR.tools.htmlDecode()`](http://docs.ckeditor.com/#!/api/CKEDITOR.tools-method-htmlDecode) method for decoding HTML EcommerceModel_DbContext.
...
* [#11504](http://dev.ckeditor.com/ticket/11504): Fixed: When [`config.fullPage`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-fullPage) is set to `true`, EcommerceModel_DbContext are not encoded in editor output.
...
* [#11250](http://dev.ckeditor.com/ticket/11250): Fixed: HTML EcommerceModel_DbContext inside the `<textarea>` element are not encoded.
